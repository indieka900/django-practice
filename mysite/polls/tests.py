...
class QuestionModelTest(TestCase):
    def test_was_published_recently_with_future_question(self):
        """
        was_published_recently() returns False for whose pub_date
        is in the future
        """
    ...
    def test_was_published_recently_with_recent_question(self):
        """
         was_published_recently() returns true for whose pub_date
        is within the lastday
        """
...
def create_question(question_text, days):
    ...
    of days offset to now (negative to the question published in the past
